...
public final class IdeaLaf extends MetalLookAndFeel {
  ...
  static void initIdeaDefaults(UIDefaults defaults) {
    ...
    defaults.put("Tree.openIcon", AllIcons.Nodes.TreeOpen);
    defaults.put("Tree.closedIcon", AllIcons.Nodes.TreeClosed);
    defaults.put("Tree.leafIcon", AllIcons.Nodes.NodePlaceholder);
    defaults.put("Tree.expandedIcon", AllIcons.Nodes.TreeExpandNode);
    defaults.put("Tree.collapsedIcon", AllIcons.Nodes.TreeCollapseNode);
